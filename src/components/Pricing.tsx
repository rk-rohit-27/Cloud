...
const PLANS: Plan[] = [
  {
    ...
    monthly: 2.99,
    yearly: 1.99,
    description: "Best for small businesses, personal projects, and beginners.",
    features: [
  ...
  },
  {
    ...
    monthly: 9.99,
    yearly: 7.99,
    description: "High-traffic websites & growing online stores.",
    features: [
      "Dedicated IP address",
      "Global CDN",
      "Up to 20x more speed",
      "Isolated virtual server resources",
      "Unlimited Bandwidth",
      "Priority Support",
    ],
    highlighted: true,
  },
  {
    ...
    monthly: 24.99,
    yearly: 19.99,
    description: "Full-stack developers & agencies needing absolute control.",
    features: [
      "Full root access",
      "Dedicated IPv6",
      "NVMe storage",
